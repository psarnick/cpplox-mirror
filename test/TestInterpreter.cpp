...
INSTANTIATE_TEST_SUITE_P(
    E2eTestInterpreter, TestInterpreterFixture,
    ::testing::Values(
        ...
        "number/literals.lox", "number/leading_dot.lox",
...
INSTANTIATE_TEST_SUITE_P(IfElseTests, TestInterpreterFixture,
                         ::testing::Values("if/dangling_else.lox",
                                           "if/else.lox", "if/if.lox",
                                           "if/truth.lox", "if/var_in_else.lox",
                                           "if/var_in_then.lox"));

INSTANTIATE_TEST_SUITE_P(LogicalOperatorTests, TestInterpreterFixture,
                         ::testing::Values("logical_operator/or.lox",
                                           "logical_operator/and_truth.lox",
                                           "logical_operator/and.lox",
                                           "logical_operator/or_truth.lox"));

INSTANTIATE_TEST_SUITE_P(WhileTests, TestInterpreterFixture,
                         ::testing::Values(
                             //"while/class_in_body.lox",
                             "while/fun_in_body.lox",
                             "while/closure_in_body.lox", "while/syntax.lox",
                             "while/return_inside.lox",
                             "while/return_closure.lox",
                             "while/var_in_body.lox"));

INSTANTIATE_TEST_SUITE_P(
    ForLoopTests, TestInterpreterFixture,
    ::testing::Values(
        //"for/class_in_body.lox",
        "for/fun_in_body.lox", "for/closure_in_body.lox", "for/scope.lox",
        "for/return_inside.lox", "for/return_closure.lox",
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        "function/extra_arguments.lox", "function/empty_body.lox",
        "function/body_must_be_block.lox", "function/missing_arguments.lox",
        "function/local_recursion.lox", "function/local_mutual_recursion.lox",
        "function/nested_call_with_arguments.lox",
        "function/mutual_recursion.lox",
        "function/missing_comma_in_parameters.lox", "function/print.lox",
        "function/parameters.lox", "function/too_many_parameters.lox",
        "function/too_many_arguments.lox", "function/recursion.lox"));

INSTANTIATE_TEST_SUITE_P(ReturnnTests, TestInterpreterFixture,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values("closure/assign_to_closure.lox",
